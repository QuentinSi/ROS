...
public:
    ...
    void set_velo(){
        ...
        jointstate.velocity[0]=0.2;
        jointstate.velocity[1]=0.2;
        send_velo.publish(jointstate);
    }
...
int main (int argc, char** argv){
    ...
    while(ros::ok()){
        ...
        //robot_real.move_manu_real_robot_group(-3.0, -1.0);
